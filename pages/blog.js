            ...
            {posts.slice(0, MAX_DISPLAY).map((frontMatter) => {
              ...
              return (
                <li key={slug} className="py-12">
                  <article className="transition ease-in-out delay-150  hover:bg-primary-30/10 hover:scale-95">
                    <div className="space-y-2 xl:grid xl:grid-cols-4 xl:space-y-0 xl:items-baseline p-10">
                      <dl>
                        ...
                        <div className="space-y-6">
                          <div>
                            <h2 className="text-2xl font-bold leading-8 tracking-tight">
                              <Link href={`/blog/${slug}`} className="text-primary-30">
                                {title}
                              </Link>
                            </h2>
